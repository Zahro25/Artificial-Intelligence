...
function App() {
  ...
  return (
    <div style={{backgroundColor:'#c9c9ff'}}>
<Navbar expand="lg" variant="light" bg="light">
  <Container>
    <Navbar.Brand href="#">Camera Security</Navbar.Brand>
  </Container>
</Navbar>
    ...
    <div className="p-3">
      ...
      <div>
        <div className="btn-toolbar" style={{paddingTop:100}}>
        ...
        <div className="row p-3">
          ...
          {!records.length
            ...
            : records.map((record) => {
                return (
                  <div className="card mt-3 w-100" key={record.title} style={{backgroundColor:'	#71c7ec'}}>
